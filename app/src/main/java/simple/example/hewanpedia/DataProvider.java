...
public class DataProvider {
    ...
    private static List<? extends Hewan> initDataAnjing(Context ctx) {
        ...
        private static List<Kelinci> initDataKelinci (Context ctx){
            ...
            kelincis.add(new Kelinci("Angora", "Turki",
                    "Jenis kelinci Anggora memiliki ciri-ciri bulu yang tebal dan lembut.", R.drawable.rabbit_anggora));
            kelincis.add(new Kelinci("Rex", "Argentina",
                    "Jika dilihat dari bulunya, jenis kelinci Rex terdapat dalam beberapa macam. Mulai dari white rex, black rex, dan dalmantian rex.", R.drawable.rabbit_rex));
            kelincis.add(new Kelinci("Himalaya", "Himalaya",
                    "Warna dasar putih dan warna lain pada bagian hidung, ekor, telinga, kaki, dan mata berwarna merah.", R.drawable.rabbit_himalaya));
            kelincis.add(new Kelinci("Dutch", "Belanda",
                    "Ciri-ciri yang paling terlihat dari jenis kelinci Dutch adalah bulunya yang pendek dan cukup bervariasi.", R.drawable.rabbit_dutch));
            kelincis.add(new Kelinci("Satin", "Amerika Serikat",
                    "Sifatnya yang jinak dan penurut menjadi alasan mengapa kelici Satin menjadi pilihan tepat untuk dipelihara.", R.drawable.rabbit_satiin));
            kelincis.add(new Kelinci("Holland Hop", "Belanda",
                    "Mereka tergolong ke kelinci berukuran mini dengan berat kurang lebih 1 kg. Meskipun bentuknya lucu dan terlihat jinak, kelinci jenis ini sebenarnya cukup sensitif.", R.drawable.rabbit_hollandhop));
            return kelincis;
        }
